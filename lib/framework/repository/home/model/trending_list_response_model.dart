...
//
//     final trendingListResponseModel = trendingListResponseModelFromJson(jsonString);

// ignore_for_file: prefer_if_null_operators

import 'dart:convert';

TrendingListResponseModel trendingListResponseModelFromJson(String str) => TrendingListResponseModel.fromJson(json.decode(str));

String trendingListResponseModelToJson(TrendingListResponseModel data) => json.encode(data.toJson());

class TrendingListResponseModel {
  TrendingListResponseModel({
    this.success,
    this.status,
    this.message,
    this.data,
  ...
  factory TrendingListResponseModel.fromJson(Map<String, dynamic> json) => TrendingListResponseModel(
